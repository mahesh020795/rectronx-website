    ...
    <section className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <motion.div
          ...
          className="bg-brand-navy rounded-3xl px-8 py-20 relative overflow-hidden"
        >
          ...
          {/* Decorative overlapping circles — right side */}
          ...
          <div className="relative max-w-2xl">
            {/* Social proof */}
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/15 text-blue-200 text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
