...
One of the most common questions we get from students working on their Final Year Projects is: "Should I use a Raspberry Pi or a microcontroller like [Arduino](/blog/arduino-project-ideas-malaysia) or [ESP32](/blog/esp32-getting-started)?" It sounds like a simple question, but the answer actually shapes your entire project — your hardware cost, your software stack, your testing approach, and even how your supervisor evaluates your work.
...
- `[flask](/blog/python-flask-web-fyp)` — if building a web interface
