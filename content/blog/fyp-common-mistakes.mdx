...
Example: "Manual attendance recording in large lecture halls is time-consuming, error-prone, and provides no real-time data to administrators. Existing [RFID](/blog/rfid-attendance-system-fyp) systems in the market are expensive and proprietary. This project develops a low-cost RFID attendance system using [ESP32](/blog/esp32-getting-started) that logs data to a central database and provides a real-time dashboard."
...
**What to do**: Always check voltage compatibility before connecting anything. ESP32 and most modern sensors run on 3.3V logic. [Arduino](/blog/arduino-project-ideas-malaysia) Uno runs on 5V. Check your datasheets. Use a multimeter to verify voltages before powering up. Keep a 10kΩ resistor set handy for pull-up/pull-down needs.
