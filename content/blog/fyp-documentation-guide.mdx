...
excerpt: "A no-nonsense guide for Malaysian engineering students on writing strong FYP technical reports — chapter by chapter, with common mistakes to avoid."
category: "FYP Guide"
date: "2026-06-14"
---
...
**[Common mistakes](/blog/fyp-common-mistakes):**
...
A good objective sounds like: "To design and implement a real-time soil moisture monitoring system using [ESP32](/blog/esp32-getting-started) that alerts users via Telegram when moisture drops below a threshold."
