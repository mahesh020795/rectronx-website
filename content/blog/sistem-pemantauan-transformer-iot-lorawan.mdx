...
LoRa (Long Range) adalah teknologi radio modulasi yang membolehkan komunikasi jarak jauh dengan kuasa rendah. Test LoRa peer-to-peer dulu sebelum integrate sensor — upload contoh `LoRaSender` dan `LoRaReceiver` dari Arduino IDE Examples.
